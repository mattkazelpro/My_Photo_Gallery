...
while ($row1 = mysqli_fetch_array($query1)) {
	...
	if ($img_votes == 0) {
		...
		echo "<tr class='row$rowcount'>
			...
			<td>$img_points / $img_votes = $img_average</td>
			<td><progress value='$imgviews' max='$highest'></progress><br>$imgviews Views</td>
			<td width='40'>
				...
				<a href='index.php?imgid=$imgid&action=deactivate'><img width ='16' border='0' title='Deactivate Image' src='images/deactivate_icon.png'></a>
			</td>
		</tr>";
